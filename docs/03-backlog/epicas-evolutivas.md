...
**Descripci�n**: Migraci�n de la validaci�n in-memory a PostgreSQL mediante sync as�ncrono, e implementaci�n de Cach� Sem�ntica con la extensi�n pgvector nativa de Postgres.

---

## EP-EVO-005

titulo: Gobernanza y Autonom�a (Dashboard Admin y SSO)
tipo: evolutivo
...
**Descripci�n**: Implementaci�n del UI administrativo protegido por SSO. Permite inyectar tokens de proveedores (KMS) y monitorear cuotas por modelo sin necesidad de despliegues.
